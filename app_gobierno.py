...
if st.session_state.page == 'Inicio':
    ...
    with col_center:
        st.markdown('<div style="text-align: center; max-width: 900px; margin: 0 auto;">', unsafe_allow_html=True)
        
        st.markdown('<h1 style="font-family: Montserrat, sans-serif; font-size: 2.5rem; color: #003d82; margin-bottom: 1.5rem; font-weight: 700;">Bienvenido al Observatorio de Seguridad de Santander</h1>', unsafe_allow_html=True)
        ...
        st.markdown('<div style="margin-top: 3rem;"><p style="font-family: Montserrat, sans-serif; font-size: 1rem; color: #999;">Selecciona una sección del menú superior para comenzar</p></div>', unsafe_allow_html=True)
