...
with col_chat:
    ...
    # Configurar avatares
    # Temporal: usa emoji hasta subir imagen a GitHub
    # Cuando subas assets/lupita.png, cambia "🌍" por "assets/lupita.png"
    LUPITA_AVATAR = "🌍"  # Cambiar por "assets/lupita.png" después
    USER_AVATAR = "assets/user-avatar.png"  # Imagen happy-face
    ...
    with col_title:
        st.markdown("""
            <div class="chat-header">
                ...
                <p>Observatorio de Seguridad de Santander</p>
            </div>
        """, unsafe_allow_html=True)
        ...
        if len(st.session_state.chat_history) == 0:
            st.markdown("""
                <div class="welcome-message">
                    <h4>👋 Hola, soy Lupita</h4>
                    <p>Tu asistente virtual para el Observatorio de Seguridad de Santander. 
                    Pregúntame sobre estadísticas, zonas, tipos de delitos y predicciones de riesgo.</p>
                </div>
            """, unsafe_allow_html=True)
