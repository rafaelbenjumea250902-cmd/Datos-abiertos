...
st.markdown("""
    ...
    * {
    ...
    /* Eliminar TODO el espacio después del header */
    .main > div:first-child {
        padding-top: 0 !important;
        margin-top: 0 !important;
    }
    
    /* Forzar que el contenido pegue al header */
...
# ========== SECCIÓN: INICIO (SIN HERO - ELIMINADO) ==========
st.markdown('<div id="inicio"></div>', unsafe_allow_html=True)

# Sin hero - vamos directo a estadísticas

# ========== SECCIÓN: ESTADÍSTICAS (DASHBOARD + CHATBOT) ==========
st.markdown('<div id="estadisticas"></div>', unsafe_allow_html=True)

# Dashboard y chat - DIRECTO después del header
