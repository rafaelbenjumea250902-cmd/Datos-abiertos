    ...
    <div class="header-container">
        <div class="header-content">
            ...
            <nav class="nav-menu">
                ...
                <a class="nav-link" href="#opinion">Cuéntanos tu Opinión</a>
            </nav>
        </div>
    </div>
""", unsafe_allow_html=True)
...
# Carrusel simulado con tabs
tab1, tab2, tab3, tab4 = st.tabs(["🏛️ Observatorio", "📊 Tendencias", "🆘 Ayuda", "💬 Tu Opinión"])
...
with tab2:
    st.markdown("""
        <div class="hero-section">
            <div class="hero-content">
                <h1>Conoce las Tendencias de Seguridad</h1>
                <p>Información actualizada de los 87 municipios</p>
                <a href="#portal-datos" class="hero-button">Portal de Datos</a>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div class="hero-section">
            <div class="hero-content">
                ...
                <p>Consulta nuestras rutas de atención</p>
                <a href="#rutas" class="hero-button">Rutas de Atención</a>
            </div>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
        <div class="hero-section">
            <div class="hero-content">
                ...
                <p>Ayúdanos a mejorar la seguridad en Santander</p>
                <a href="#opinion" class="hero-button">Cuéntanos tu Opinión</a>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
st.markdown("""
    <div class="section">
        <h2 class="section-title">Estadísticas de Seguridad</h2>
        <p class="section-subtitle">Dashboard interactivo y asistente virtual Lupita</p>
    </div>
""", unsafe_allow_html=True)

col_dashboard, col_chat = st.columns([7, 3], gap="medium")
