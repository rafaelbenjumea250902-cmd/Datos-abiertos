...
# Título y subtítulo con menos padding
st.markdown("""
    <div style="padding: 2rem 2rem 1rem; text-align: center;">
        <h2 class="section-title" style="margin-bottom: 0.5rem;">Estadísticas de Seguridad</h2>
        <p class="section-subtitle" style="margin-bottom: 0;">Dashboard interactivo y asistente virtual Lupita</p>
    </div>
""", unsafe_allow_html=True)

# Grid sin espacios - inmediatamente después del título
...
with col_dashboard:
    ...
    components.iframe(POWER_BI_URL, height=650, scrolling=False)
