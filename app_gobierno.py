...
# Título minimalista SIN espacios
st.markdown("""
    <h2 style="text-align: center; color: #003d82; font-family: 'Montserrat', sans-serif; 
    font-size: 2.5rem; font-weight: 700; margin: 1rem 0 0.5rem 0; padding: 0;">
    Estadísticas de Seguridad</h2>
    <p style="text-align: center; color: #666; font-family: 'Open Sans', sans-serif; 
    font-size: 1.1rem; margin: 0 0 0.5rem 0; padding: 0;">
    Dashboard interactivo y asistente virtual Lupita</p>
""", unsafe_allow_html=True)

# Dashboard y chat INMEDIATAMENTE después
