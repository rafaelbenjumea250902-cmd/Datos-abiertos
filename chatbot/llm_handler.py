...
class ChatbotHandler:
    """
    Maneja las interacciones con Groq API (ultra rápida y gratis)
    """
    ...
    def __init__(self):
        ...
        if api_key:
            ...
            self.model = "llama-3.3-70b-versatile"  # Modelo más potente gratis
...
4. Mantén respuestas CONCISAS (máximo 2-3 párrafos cortos)
5. Ve directo al punto, sin introducciones largas

Responde siempre de manera útil, directa y basada en datos.
"""
    ...
    def get_response(self, user_message: str, max_tokens: int = 300) -> str:
        """
        Genera una respuesta usando Groq (ultra rápido)
        """
