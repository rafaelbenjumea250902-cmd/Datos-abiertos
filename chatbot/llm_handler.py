...
class ChatbotHandler:
    ...
    def __init__(self):
        ...
        # Configurar Google Gemini con nueva API
        api_key = os.getenv("GEMINI_API_KEY")
        
        if api_key:
            # Pasar API key explícitamente al cliente
...
"""
    ...
    def get_response(self, user_message: str, max_tokens: int = 500) -> str:
        """
        Genera una respuesta usando Google Gemini (nueva API)
        """
        ...
        try:
            ...
            # Generar respuesta usando nueva API de Gemini
...
- Configurar GEMINI_API_KEY en los Secrets de Streamlit
