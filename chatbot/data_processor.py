...
class DataProcessor:
    ...
    def load_data(self) -> bool:
        ...
        try:
            ...
            bga_pred_path = os.path.join(self.data_dir, "predicciones_riesgo_bucaramanga_20251126_005322__1_.csv")
            ...
            general_path = os.path.join(self.data_dir, "001_General.csv")
