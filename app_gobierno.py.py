...
# CAMBIO CRÍTICO: Remover height fijo, usar 100% para llenar el contenedor
components.iframe(POWER_BI_URL, height=None, scrolling=True)

st.markdown('</div>', unsafe_allow_html=True)

# SECCIÓN CHAT (25% - DERECHA)
